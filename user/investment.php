...
<head>
    ...
    <title>Investment Plan | Investify </title>
...
<body>
                        ...
                        <div class="header-main-content-wrapper">
                            ...
                            <div class=" header-main-middle">
                                ...
                                <div class="header-main-right-btn d-none d-lg-inline-block">
                                    <a class="btn btn--outline-base mr-10" href="dashboard.php">
                                        Dashboard </a>
                                    <a class="btn btn--outline-base mr-10" href="logout.php">
                                        Logout
                                    </a>
                                </div>
                            </div>
    ...
    <section class="breadcrumb-area primary-bg p-relative pt-120 pb-80">
        <div class="breadcrumb-area__shape">
            <img class="w-img"
                src="../assets/templates/hyip_gold/images/breadcrumb/breadcrumb-shape.png" alt="Image">
        </div>
        <div class="breadcrumb-area__shape2">
            <img class="w-img" src="../assets/templates/hyip_gold/images/banner/shape.png" alt="Image">
        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                        <div class="breadcrumb-area__inner">
                            <h2 class="breadcrumb-area__inner-title" style="color: white;">
                                Investment Plan
                            </h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 text-end">
                        <div class="breadcrumb-right-content d-none d-md-inline-block">
                            <img class="w-img banner-right-image"
                                src="../assets/templates/hyip_gold/images/affilate-image.png"
                                alt="Image">
                        </div>
                    </div>
                </div>
    ...
    <section class="section-common-bg pt-160 pb-140">
        <div class="container">
            <div class="row mb-none-50 justify-content-center">
                ...
                <div class="price-btn">
                                <a href="buy-plan.php" class="btn btn--base  investModal" >
                                    Invest Now </a>
                            </div>
    ...
    <script src="../assets/global/js/jquery-3.6.0.min.js"
        type="text/javascript"></script>
    <script src="../assets/global/js/bootstrap.bundle.min.js"
        type="text/javascript"></script>
        ...
        (function($) {
            ...
            $('.investModal').click(function() {
                ...
                if (plan.interest_type == '1') {
                    modal.find('.interestDetails').html(`<strong> Earning: ${interestAmount}% </strong>`);
                } else {
                    modal.find('.interestDetails').html(
                        `<strong> Earning: ${interestAmount} ${currency}  </strong>`);
                }
                if (plan.lifetime == '0') {
